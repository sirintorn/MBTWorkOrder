...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    mBTWorkOrderAuthUserSubject.add(
      MBTWorkOrderAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MBTWorkOrderAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MBTWorkOrderAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MBTWorkOrderAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    mBTWorkOrderAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
