...
import 'add_machine_model.dart';
export 'add_machine_model.dart';

class AddMachineWidget extends StatefulWidget {
  const AddMachineWidget({super.key});

  @override
  _AddMachineWidgetState createState() => _AddMachineWidgetState();
}

class _AddMachineWidgetState extends State<AddMachineWidget> {
  late AddMachineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddMachineModel());
                                                          ...
                                                          borderRadius:
                                                              BorderRadius
                                                                  .circular(
                                                                      26.0),
                                                          child: Image.network(
                                                            'https://2.bp.blogspot.com/-yY_b4mpvEu4/TcYTjx5W5yI/AAAAAAAAEJ0/FQNQm1iaoAs/s1600/High-Rib-Roofing-Panel-Roll-Forming-Machine.jpg',
                                                            width: 36.0,
                                                            height: 36.0,
                                                            fit: BoxFit.cover,
                                                          ),
